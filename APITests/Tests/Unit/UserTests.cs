...
public class UsersTests
{
    ...
    {
        var fakeResponse = new RestResponse { StatusCode = OK, Content = LoadEmbeddedText("Tests/Unit/TestData/ListUsers_Page2.json") };
    ...
    {
        var fakeResponse = new RestResponse { StatusCode = OK, Content = LoadEmbeddedText("Tests/Unit/TestData/GetUser_Id2.json") };
    ...
    {
        var fakeResponse = new RestResponse { StatusCode = NotFound, Content = LoadEmbeddedText("Tests/Unit/TestData/GetUser_NotFound.json") };
    ...
    {
        var fakeResponse = new RestResponse { StatusCode = NoContent, Content = LoadEmbeddedText("Tests/Unit/TestData/DeleteUser_Success.json") };
    ...
    {
        var fakeResponse = new RestResponse { StatusCode = OK, Content = LoadEmbeddedText("Tests/Unit/TestData/ListUsers_Page1_Delayed.json") };
